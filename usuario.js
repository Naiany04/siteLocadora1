...
{ //arrow function
    ...
    .catch(e => console.log('Erro insperado '+ e, message))
})

    //alimentar todos os campos do formulario 
const mostrarDados = (result) =>{//aqui busco o retorno
    for(const campo in result){ //aqui armazena todo o retorno na variavel campo
        if(document.querySelector("#"+campo)){ //verifica se o campo existe
